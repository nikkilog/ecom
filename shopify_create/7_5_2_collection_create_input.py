...
GitHub target: ``ecom/shopify_create/7_5_2_collection_create_input.py``
Import path: ``shopify_create.7_5_2_collection_create_input``
...
MODULE_VERSION = "2026-09-23-flexible-collection-create-input-v2"
MODULE_PATH = "shopify_create.7_5_2_collection_create_input"
DEFAULT_JOB_NAME = "collection_create_input"
...
# These aliases are intentionally exposed because the Local/Colab runners use the
# business module as their single infrastructure boundary during bootstrap.
